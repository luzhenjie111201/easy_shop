         ...
         <!--配送方式-->
                  ...
                  <div class="mode-tab-nav">
                    <ul>
							...
							<span id="jdShip-span-tip" class="m-txt">淘淘快递<i class='qmark-icon qmark-tip' data-tips='由淘淘公司负责配送，速度很快，还接受上门刷卡付款服务'></i></span><b></b>
                        </li>
...
<script type="text/javascript">
        ...
        function doSavePickShipDate(venderId){
           ...
           jQuery.closeDialog();
			         ...
			         <!--以下为淘淘第三方配送-->					
					 				<!--以下为第三方配送-->	 				
				<!--如果是SOP快递或者是淘淘中小件商品，但是不支持配送，则采用快递运输-->
				   			</div><!--dis-modes 结束-->
			<div class="clr"></div>
	   ...
	   <!-- 淘淘配送 -->
	   <input type="hidden" id="saveParam_jdShipmentType" name="saveParam.jdShipmentType" value="" /><!--淘淘配送-->
	   ...
	   <input type="hidden" id="saveParam_jdCheckType" name="saveParam.jdCheckType" value="2"/><!--如果是支票这个只是写死的[仅支持淘淘上门自取]-->
	   <input type="hidden" id="saveParam_jdBigItemShipTimeOffset" name="saveParam.jdBigItemShipTimeOffset" value="0"/><!--淘淘大家电安装时间偏移量-->
	   <input type="hidden" id="saveParam_jdBigItemInstallTimeOffest" name="saveParam.jdBigItemInstallTimeOffest" value="0"/><!--淘淘大家电配送时间偏移量-->	  
	   <!--311-->
	   ...
	   <input type="hidden" id="saveParam_jdBigItemNightShip" name="saveParam.jdBigItemNightShip" value="false"/><!--大家电是否支持晚间配送-->	   	   
	    <!--淘淘第三方配送-->
	   <input type="hidden" id="saveParam_otherShipmentType" name="saveParam.otherShipmentType" value=""/><!--淘淘第三方配送-->
	   <input type="hidden" id="saveParam_otherShipTime" name="saveParam.otherShipTime" value=""/><!--区分工作日，311，411-->	   
	   <input type="hidden" id="saveParam_otherBigItemShipOffset" name="saveParam.otherBigItemShipOffset" value=""/><!--淘淘大家电安装时间偏移量-->
	   <input type="hidden" id="saveParam_otherBigItemInstallTimeOffset" name="saveParam.otherBigItemInstallTimeOffset" value=""/><!--淘淘大家电配送时间偏移量-->
...
<div class="order-summary">
	<!--  预售 计算支付展现方式 begin -->
		...
		<div class="list">
			<span><em class="ftx-01">${carts.size()}</em> 件商品，总商品金额：</span>
    ...
    <div class="list" id="showFreeFreight"  style="display:none;" >
      <span>运费优惠：</span><em class="price" id="freeFreightPriceId"> -￥0.00</em>
		...
		<div class="list" id="showGiftCardPrice"  style="display:none;" >
			<span>淘淘卡/E卡：</span><em class="price" id='giftCardPriceId'>-￥ 0.00</em>
		</div>
